              ...
              {categories.map((category) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="ml-2 bg-white text-brand-green-dark text-xs px-2 py-1 rounded-full font-bold">
                      {productCount}
                    </span>
                  </a>
                );
      ...
      <section className="py-16 bg-brand-green-dark text-white">
        <div className="px-0 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"
              className="bg-white text-brand-green-dark font-bold py-4 px-8 rounded-full hover:bg-gray-100 transition-all duration-300 transform hover:scale-105"
            >
